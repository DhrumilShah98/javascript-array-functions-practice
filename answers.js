...
//************
//1. Sort by mass
console.log(characters.sort(function(char1, char2){ return char1.mass > char2.mass }));

//2. Sort by height
console.log(characters.sort(function(char1, char2){ return char1.height > char2.height }));

//3. Sort by name
console.log(characters.sort(function(char1, char2){ return char1.name.toUpperCase() > char2.name.toUpperCase() }));

//4. Sort by gender
console.log(characters.sort(function(char1, char2){ return char1.gender.toUpperCase() > char2.gender.toUpperCase() }));

//*************
//*** EVERY ***
//*************
//1. Does every character have blue eyes?
console.log(characters.every(function(character){ return character.eye_color === 'blue'; }));

//2. Does every character have mass more than 40?
console.log(characters.every(function(character){ return character.mass > 40; }));

//3. Is every character shorter than 200?
console.log(characters.every(function(character){ return character.height < 200; }));

//4. Is every character male?
console.log(characters.every(function(character){ return character.gender === 'male'; }));

//************
//*** SOME ***
//************
//1. Is there at least one male character?
console.log(characters.some(function(character){ return character.gender === 'male'; }));

//2. Is there at least one character with blue eyes?
console.log(characters.some(function(character){ return character.eye_color === 'blue'; }));

//3. Is there at least one character taller than 210?
console.log(characters.some(function(character){ return character.height > 210; }));

//4. Is there at least one character that has mass less than 50?
console.log(characters.some(function(character){ return character.mass < 50; }));
